function [random_forest] = train(images, masks)
features = [];
labels = [];
...
for i=1:size(images, 2)
    ...
    % countouring pixels are 1, background pixels are 10
...
% get all pixels that are relevant for training (1, 5, 10)
